    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <h1 style="font-size: 28px;" class=" text-center">Lista de Clientes</h1>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="content-box-large">
                                ...
                                <div class="panel-body">
                                    ...
                                    <a href="{{ route('admin/clientes/crear') }}" class="btn btn-success mt-4 ml-3">
                                        Crear
                                    </a>
                                                    ...
                                                    @foreach ($clientes as $clie)
                                                        <tr>
                                                            <td scope="row" class="v-align-middle">
                                                                {{ $clie->name}}</td>
                                                            <td class="v-align-middle">{{ $clie->email }}</td>
                                                            <td class="v-align-middle">{{ $clie->direccion }}</td>
                                                            <td class="v-align-middle">
                                                                <img src="{!! asset("uploads/$clie->img") !!}" width="30"
                                                                    class="img-responsive">
                                                            </td>
                                                            <td class="v-align-middle">

                                                                <form
                                                                    action="{{ route('admin/clientes/eliminar', $clie->id) }}"
                                                                    ...
                                                                    <input type="hidden" name="_token"
                                                                        value="{{ csrf_token() }}">
                                                                    <a href="{{ route('admin/clientes/detalles', $clie->id) }}"
                                                                        class="btn btn-dark">Detalles</a>
                                                                    <a href="{{ route('admin/clientes/actualizar', $clie->id) }}"
        ...
        function borrar(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location = "index.php?txtID=" + name;
                    Swal.fire(
                        'Borrado!',
