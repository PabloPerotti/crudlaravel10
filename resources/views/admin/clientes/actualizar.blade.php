    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <h1 style="font-size: 28px;" class=" text-center">Actualizar Cliente de la Lista</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin/clientes') }}">Clientes</a>
                                    </li>
                                    ...
                                    <div class="content-box-large">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <section class="example mt-4">
                                                ...
                                                <form method="POST"
                                                    action="{{ route('admin/clientes/update', $clientes->id) }}"
